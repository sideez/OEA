<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="habitat-artwork.aspx.cs" Inherits="OEA.habitat_artwork" %>
...
<body>
    <form id="habitatArtworkForm" runat="server">
...
<div class="row header">
  ...
  <div class="row main">
    ...
    <h1>Build an Animal Habitat Artwork</h1>
<p>Have you ever imagined what your bedroom would look  like if you were a duck? Would the wallpaper look like trails of breadcrumbs?  What would your bedroom look like if you were a toad? Would the rug be a great  big lily pad? Here are drawings created by our girl members imagining what  their rooms would look like if they were an animal! <a href="nsp-artwork.aspx">Would you like to submit  your drawing?</a> Don&rsquo;t forget to visit our <a href="treasure-artwork.aspx">Transforming Trash to  Treasure artwork</a> too!</p>
